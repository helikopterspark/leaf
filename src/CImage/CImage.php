...
class CImage {
    ...
    /**
     * Get incoming parameters for image processing and validate them
     *
     */
    ...
    private function errorMessage($message) {
        ...
        die('Image error - ' . htmlentities($message));
    }
...
EOD;
     ...
     *
     */
    private function calculateNewImgSize() {
