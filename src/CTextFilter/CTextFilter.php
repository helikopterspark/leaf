...
class CTextFilter
{
    public static $instance = null;	// For Purify()
...
EOD;
	...
	public static function smartyPantsTypographer($text) {
  		require_once(__DIR__ . '/PHPSmartyPants151f/smartypants.php');
   ...
   */
   public static function Purify($text) {   
    if(!self::$instance) {
      require_once(__DIR__.'/htmlpurifier460standalone/HTMLPurifier.standalone.php');
